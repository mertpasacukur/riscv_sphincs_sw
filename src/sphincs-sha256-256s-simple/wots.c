 ...
 */
MY_STATIC void wots_gen_sk(unsigned char *sk, const unsigned char *sk_seed,
 ...
 */
MY_STATIC void gen_chain(unsigned char *out, const unsigned char *in,
 ...
 */
MY_STATIC void base_w(unsigned int *output, const int out_len,
...
MY_STATIC void wots_checksum(unsigned int *csum_base_w,
...
MY_STATIC void chain_lengths(unsigned int *lengths, const unsigned char *msg)
{
...
/**
 * Takes a n-byte message and the 32-byte sk_seed to compute a signature 'sig'.
 */
