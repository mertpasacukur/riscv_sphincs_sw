...
MY_STATIC void fors_gen_sk(unsigned char *sk, const unsigned char *sk_seed,
                        uint32_t fors_leaf_addr[8])
{
    prf_addr(sk, sk_seed, fors_leaf_addr);
}

MY_STATIC void fors_sk_to_leaf(unsigned char *leaf, const unsigned char *sk,
...
MY_STATIC void fors_gen_leaf(unsigned char *leaf, const unsigned char *sk_seed,
                          const unsigned char *pub_seed,
 ...
 */
MY_STATIC void message_to_indices(uint32_t *indices, const unsigned char *m)
{
    unsigned int i, j;
